...
def main(input_file):
    ...
    df = add_fourier_terms(df, 'month', month_period, num_terms=6)
    df = add_fourier_terms(df, 'day', day_period, num_terms=6)
    df = add_fourier_terms(df, 'hour', hour_period, num_terms=6)
